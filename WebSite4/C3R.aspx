<%@ Page Language="C#" AutoEventWireup="true" CodeFile="C3R.aspx.cs" Inherits="C3R" %>
...
<body style="height: 954px">
    <form id="form1" runat="server" style="background-image: url('NewFolder1/bg2.jpg')">
         <center style="height: 813px">
        <asp:Label ID="Label1" runat="server" Text="SPRING/FALL OFFERED COURSES" Font-Bold="True" Font-Italic="True" Font-Names="Cooper Black" Font-Size="XX-Large" ForeColor="#000066"></asp:Label>
            <br />
            <br />
            <br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectConnectionString %>" SelectCommand="SELECT [COURSE_CODE], [COURSE_NAME], [CREDIT_HOURS], [POST_REQ], [SEMESTER], [DEPT], [COURSE_COORDINATOR_ID] FROM [COURSE] WHERE ([SEMESTER] = @SEMESTER2)">
            <SelectParameters>
                <asp:Parameter DefaultValue="SPRING/FALL" Name="SEMESTER2" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
             <br />
